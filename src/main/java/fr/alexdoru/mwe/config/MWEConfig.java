...
public class MWEConfig extends AbstractConfig {
    ...
    @ConfigProperty(
            category = VANILLA, subCategory = I18n.format("mwe.config.category.vanilla.chat_search"),
            name = "Search box X offset", displayname = I18n.format("mwe.config.category.vanilla.chat_search.colorArmorWhenHurt"),
            comment = I18n.format("mwe.config.category.vanilla.chat_search.colorArmorWhenHurt.comment")
